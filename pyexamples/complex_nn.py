...
arch_full = [
    ...
    to_ConvC(**convfn(32)),
    # l2
    to_ConvCS(**conv_stride_fn(32)),
    connect_lazy(),
    to_ConvC(**convfn(64)),
    # l3
    to_ConvCS(**conv_stride_fn(64)),
    connect_lazy(),
    to_ConvC(**convfn(128)),
    # l4
    to_ConvCS(**conv_stride_fn(128)),
    connect_lazy(),
    to_ConvC(**convfn(128)),
    # l5
    to_ConvCT(**conv_trans_fn(128)),
    connect_lazy(),
    to_ConvC(**convfn(128)),
    # l6
    to_ConvCT(**conv_trans_fn(64)),
    connect_lazy(),
    to_ConvC(**convfn(64)),
    # l7
    to_ConvCT(**conv_trans_fn(32)),
    connect_lazy(),
    to_ConvC(**convfn(32)),
    # l8
    to_ConvCT(**conv_trans_fn(16)),
    connect_lazy(),
    to_ConvC(**convfn(1)),
